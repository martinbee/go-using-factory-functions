...
createBoard.currentColor = createBoard.BLACK;

// Switches the current player
createBoard.switchPlayer = function() {
  this.currentColor = this.currentColor === this.BLACK ? this.WHITE : this.BLACK;
}

// Pass ability
createBoard.pass = function() {
...
createBoard.resetGame = function() {
...
createBoard.getAdjacentIntersections = function(i, j) {
  const neighbors = [];
...
createBoard.getGroup = function(i, j) {
  const { board } = this;
